...
import { CustomButton, CustomButton1, CustomColor, CustomFont, CustomTab, CustomeButton2, DetailsContainer, DetailsWrapper, HeroContainer, Line, MarkContainer, StatusBar, VLine } from './style';
...
const Details = () => {
    return <DetailsContainer>
        ...
        <DetailsWrapper>
            ...
            <Flex $style={{ hAlign: 'space-between', p: '40px 0 0', w: '100%' }}>
