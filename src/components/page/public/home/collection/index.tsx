...
import { ArrowButton, CardContainer, CardContainer1, CardWrapper, CollectionContainer, ContentColor, Cursor, Mark1, Mark2, Progress, ProgressContainer, Rect1, Rect2, Rect3, SlideCard } from './style';
